...
export default function PopulerMatchCard({team, date, highlight, matchIndex, setSelectedMatch}) {

    return (
        <div className='puplermatch-card' style={{cursor:'pointer', height: '85px', width: '300px', border: "1px solid black", boxShadow: '1px 1px 5px #1175cb', margin: "5px 10px", background: 'honeydew', padding:'5px 8px' }} onClick={() => setSelectedMatch(matchIndex)}>
            <div>
